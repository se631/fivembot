        ...
        async function panelGuncelle() {
            ...
            try {
                ...
                if (tarihKanal) {
                    ...
                    if (tarihKanal.name !== yeniIsim) await tarihKanal.setName(yeniIsim).catch(() => {});
                }
                ...
                if (aktifKanal) {
                    ...
                    if (aktifKanal.name !== yeniIsim) await aktifKanal.setName(yeniIsim).catch(() => {});
                }

                // 3. Toplam Üye (Rolü olanlar)
                ...
                if (toplamKanal) {
                    ...
                    if (toplamKanal.name !== yeniIsim) await toplamKanal.setName(yeniIsim).catch(() => {});
                }
            } catch (err) { console.error("Stats hatası:", err); }
        }

        setInterval(panelGuncelle, 10000); // 10 Saniye
